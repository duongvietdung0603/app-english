...
import { ArrowLeft, FileText, Clock, Target, ChevronRight, Star, Award, Zap, BookOpen } from "lucide-react"
...
export default function ParagraphTopicsPage() {
  ...
  useEffect(() => {
    const fetchTopics = async () => {
      try {
        const response = await fetch(`/api/paragraph-topics/${language}`)
        ...
        console.error("Error fetching paragraph topics:", error)
      } finally {
        setIsLoading(false)
      }
    }
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-slate-400">Loading paragraph topics...</div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-slate-900 text-slate-100">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg font-semibold text-slate-100">Paragraph Translation Topics</h1>
                  <p className="text-xs text-slate-400">
                    {languageFlags[language as keyof typeof languageFlags]}{" "}
                    {languageNames[language as keyof typeof languageNames]} Advanced Practice
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-purple-300">
                  {topics.reduce((acc, topic) => acc + topic.paragraphsCount, 0)} Paragraphs
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-slate-100 mb-4">Advanced Paragraph Translation</h2>
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            Challenge yourself with complex paragraphs and develop advanced translation skills with real-time feedback.
          </p>
        </div>
          ...
          {filteredTopics.map((topic) => (
            ...
            >
              <CardHeader className="pb-3">
                ...
                <CardTitle className="text-lg text-slate-100 group-hover:text-purple-400 transition-colors">
                  {topic.title}
                </CardTitle>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-slate-400">{topic.paragraphsCount} paragraphs</span>
                  </div>
                  <div className="flex items-center space-x-1">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-slate-400">{topic.averageLength}</span>
                  </div>
                  <div className="flex items-center space-x-1">
                ...
                <div className="space-y-1">
                  <div className="text-xs font-medium text-slate-400">Content areas:</div>
                ...
                {/* Action Button */}
                <Link href={`/practice/${language}/paragraph-translation?topic=${topic.id}`} className="block">
                  <Button className="w-full bg-purple-600 hover:bg-purple-700 group-hover:bg-purple-500 transition-all">
                    Start Challenge
        ...
        {/* Achievement Section */}
        <div className="mt-12 bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-100">Master Complex Translation</h3>
                <p className="text-slate-400">
                  Complete all paragraph topics to become an expert in complex text translation and earn premium badges.
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
